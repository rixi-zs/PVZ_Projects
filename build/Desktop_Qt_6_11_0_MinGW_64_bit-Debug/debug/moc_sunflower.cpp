...
namespace {
struct qt_meta_tag_ZN9SunFlowerE_t {};
} // unnamed namespace

template <> constexpr inline auto SunFlower::qt_create_metaobjectdata<qt_meta_tag_ZN9SunFlowerE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<SunFlower, qt_meta_tag_ZN9SunFlowerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject SunFlower::staticMetaObject = { {
    ...
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN9SunFlowerE_t>.metaTypes,
    nullptr
} };

void SunFlower::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<SunFlower *>(_o);
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->produceSun(); break;
        default: ;
        }
    }
    (void)_a;
